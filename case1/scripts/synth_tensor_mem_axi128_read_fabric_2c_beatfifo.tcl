# Artix-7 proxy for the integrated read fabric with beat-record leaf FIFOs.
# All dimensions match the logical-mode fabric proxy except the forwarded
# response-record layout and the smaller per-leaf response depth.
...
create_project -in_memory c1_tensor_mem_axi128_read_fabric_2c_beatfifo_proxy -part xc7a200tsbg484-1
...
synth_design -top c1_tensor_mem_axi128_read_fabric_2c -part xc7a200tsbg484-1 \
    ...
    -generic {LEAF_REQ_FIFO_DEPTH=16 LEAF_BURST_BEATS=4 \
              LEAF_MAX_OUTSTANDING=4 LEAF_RSP_FIFO_DEPTH=16 \
              FABRIC_FIFO_DEPTH=8 BUILD_TIMEOUT_CYCLES=3 \
              ALLOW_SAME_LANE_DUP=1 LEAF_RSP_FIFO_BEAT_MODE=1}
...
puts "C1_TENSOR_MEM_AXI128_READ_FABRIC_BEAT_FIFO_PROXY_SYNTH_PASS"
close_project
