...
def vectors(directory, width, height, profile='drop_res1', package=None, parameter_override=None):
    ...
    info = dict(sources=sources, actual_resize_golden=True, unstoppable_source=True, actual_roi=True, profile=profile, width=width, height=height, stage_count=len(nodes),
