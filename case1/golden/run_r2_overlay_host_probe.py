"""C22 feature-overlay generated plan through real RGBX/AXI/video/host RTL, not CPU IP."""
...
PROJECT = ROOT/'efinity/c1_ti60_r2_overlay_host96.xml'
...
SOURCES = [(PROJECT.parent/e.attrib['name']).resolve().relative_to(ROOT).as_posix()
           ...
           if e.tag.rsplit('}', 1)[-1] == 'design_file' and e.attrib['name'] != 'c1_ti60_r2_overlay_host96.sv']
SIM = ['sim/c1_r2_axi_memory_bfm.sv', 'sim/c1_r2_axi_traffic_agent.sv']
TOP = 'tb_c1_r2_overlay_host_system'
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='c1_r2_overlay_host_', dir=ROOT/'sim') as td:
        root = Path(td)
        if a.compile_only:
            ...
            c = subprocess.run(['D:/iverilog/bin/iverilog.exe', '-g2012', '-s', 'c1_r2_overlay_host_system',
