"""C24 independent Resize->CNN fixtures for a private no-wave xsim run."""
import argparse
import json
from pathlib import Path
from r2_resize_plan_vectors import vectors
...
def main():
    ...
    print('C1_R2_RESIZE_HOST_VECTOR_BUILD '+json.dumps(dict(profile=a.profile,
          width=a.width, height=a.height, sources=m['sources'], actual_resize_golden=True,
