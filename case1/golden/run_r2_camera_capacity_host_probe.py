"""C29 feature-resize generated plan through real RGBX/AXI/video/host RTL, not CPU IP."""
...
PROJECT = ROOT/'efinity/c1_ti60_r2_camera_capacity96.xml'
...
SOURCES = [(PROJECT.parent/e.attrib['name']).resolve().relative_to(ROOT).as_posix()
           ...
           if e.tag.rsplit('}', 1)[-1] == 'design_file' and e.attrib['name'] != 'c1_ti60_r2_camera_capacity96.sv']
SIM = ['sim/c1_r2_axi_memory_bfm.sv', 'sim/c1_r2_axi_traffic_agent.sv']
TOP = 'tb_c1_r2_camera_capacity_host_system'
PREFIX = 'C1_R2_CAMERA_CAPACITY_HOST_SYSTEM_'
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='c1_r2_camera_capacity_host_', dir=temp_parent) as td:
        root = Path(td)
        if a.compile_only:
            ...
            c = subprocess.run(['D:/iverilog/bin/iverilog.exe', '-g2012', '-s', 'c1_r2_camera_capacity_host_system',
