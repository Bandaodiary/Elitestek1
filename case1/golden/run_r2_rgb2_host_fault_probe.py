...
from run_r2_rgb2_host_probe import ROOT, SOURCES, PLAN_SOURCE, SIM
from r2_camera_plan_vectors import vectors, compile_package, profile_nodes, camera_geometry

TOP = 'tb_c1_r2_rgb2_host_faults'
PREFIX = 'C1_R2_RGB2_HOST_FAULT_'
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='c1_r2_rgb2_host_fault_', dir=temp_parent) as td:
        root = Path(td)
