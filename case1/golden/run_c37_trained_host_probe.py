"""C37 six-replacement regression on the actual AXI/video/host RTL."""
import argparse
import json
from pathlib import Path
import subprocess

from c37_trained_contract import (ROOT,bound_candidate,build_vectors,camera_geometry,
...
def main():
    ...
    for case in CASES:
        ...
        print('C37_TRAINED_HOST_CASE_BEGIN '+json.dumps(case,separators=(',',':')),flush=True)
        ...
        print('C37_ACTUAL_COMPILE '+json.dumps(command),flush=True)
        ...
        print('C37_ACTUAL_RUN '+json.dumps(command),flush=True)
        ...
        if case['negative']:
            ...
            print('C37_NEGATIVE_OBSERVED '+json.dumps(dict(record,fatal_lines=actual)),flush=True)
        else:
            ...
            print('C37_POSITIVE_CHECK '+json.dumps(record,separators=(',',':')),flush=True)
        results.append(record)
        print('C37_TRAINED_HOST_CASE_END '+case['id'],flush=True)
    print('C37_TRAINED_HOST_MATRIX_PASS '+json.dumps(dict(model_binding=provenance,
