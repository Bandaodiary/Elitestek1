`timescale 1ns/1ps
// C32 candidate: transmit a committed prefix while a row is still computed.
...
module c1_r2_tensor_cutthrough_writer (
    ...
    wire read_fire=state==STREAM && stream_enable && read_index<send_words && read_index<ready_words[send_page] && (!held_valid || data_ready);
    wire [127:0] ram_data;
