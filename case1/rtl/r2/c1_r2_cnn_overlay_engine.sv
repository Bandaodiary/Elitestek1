...
// PW/residual overlays spatial row0. Refill features after changing the
// storage interpretation; the two logical feature pools are NOT persistent.
// Internal prototype ABI;
// no DDR/CPU integration. All job writes and starts are mutually exclusive.
module c1_r2_cnn_overlay_engine (
    input wire clk,rst,
    input wire [2:0] mode,
    ...
    wire legal_bulk=legal_bulk_group && (load_linear_pool ? bulk_linear_address<512 : bulk_row<3 && bulk_spatial_address<1024);
    ...
    c1_r2_pw_overlay_feeder u_linear (
    ...
    c1_r2_spatial_overlay_feeder u_spatial (
