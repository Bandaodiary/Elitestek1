// C21 six-lane weight baseline, restored from retained C18 + audited C21 deltas.
...
module c1_r2_cnn_compact_engine (
    input wire clk,rst,
    input wire [2:0] mode,
    ...
    c1_r2_spatial_lane_feeder u_spatial (
