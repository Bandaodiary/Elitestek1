...
module c1_r2_cnn_bulk_engine (
    ...
    wire [12:0] bulk_linear_address=times_group(bulk_pair,bulk_groups==2 ? 3'd1 : bulk_groups==3 && mode==0 ? 3'd2 : 3'd3)+(mode==3 ? ((3+bulk_group)>>1) : (bulk_group>>1));
    ...
    c1_r2_spatial_bulk_feeder u_spatial (
