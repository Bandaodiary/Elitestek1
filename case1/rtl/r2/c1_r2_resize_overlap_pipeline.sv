...
// and c1_r2_resize_line_sampler.  There is no external four-point sampling
...
module c1_r2_resize_overlap_pipeline #(
    ...
    c1_r2_resize_overlap_system u_resize_system (
        .clk,
        .rst(engine_rst),
        .start(engine_start),
