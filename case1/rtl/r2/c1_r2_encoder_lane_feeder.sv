...
module c1_r2_encoder_lane_feeder (
    ...
    for(genvar lane=0;lane<6;lane=lane+1) begin : g_lane_address
        wire [5:0] channel={1'b0,channel_base}+lane;
        assign weight_lane_addr[lane*9+:9]={channel[2:0],channel[5:3],k_q};
    end
    ...
    for(genvar r=0;r<6;r=r+1) begin : g_operand
        ...
        assign req_b[r*128+:128]=weight_data[r*128+:128];
