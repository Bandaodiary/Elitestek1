...
module c1_cdc_latest_snapshot_guarded #(parameter integer WIDTH=41) (
    ...
    (* async_reg="true", syn_keep="true" *) logic req_sync1_q, req_sync2_q;
    (* async_reg="true", syn_keep="true" *) logic ack_sync1_q, ack_sync2_q;
