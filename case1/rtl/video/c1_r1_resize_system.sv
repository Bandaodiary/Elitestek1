...
//   y0x0, y0x1, y1x0, y1x1.
// A responder may assert sample_rsp_valid as soon as the request handshake
// occurs, but must hold all response samples until sample_rsp_ready is high.
...
// The added bubbles are intentional: this correctness-first system already has
// a synchronous-RAM request latency and supports arbitrary downstream stalls.
