// C23 standalone Resize resource probe, dynamic geometry/Q16 phases.
// RGB888 ready/valid source; not a CSI frontend or a complete R2 host.
module c1_ti60_r2_resize_reference (
    ...
    c1_r1_resize_pipeline #(.MAX_WIDTH(2048),.REGISTER_ABORT_RESET(1)) u_resize (
