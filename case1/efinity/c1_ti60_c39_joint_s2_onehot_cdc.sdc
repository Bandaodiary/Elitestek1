...
set_max_delay -from [get_clocks cam_clk] -to [get_pins {u_host/u_system/u_ingress/req_sync1~FF|D u_host/u_system/u_ingress/done_sync1~FF|D u_host/u_system/u_ingress/bad_sync1~FF|D u_host/u_system/u_camera_snapshot/req_sync1_q~FF|D}] 5.000
set_false_path -hold -from [get_clocks cam_clk] -to [get_pins {u_host/u_system/u_ingress/req_sync1~FF|D u_host/u_system/u_ingress/done_sync1~FF|D u_host/u_system/u_ingress/bad_sync1~FF|D u_host/u_system/u_camera_snapshot/req_sync1_q~FF|D}]
