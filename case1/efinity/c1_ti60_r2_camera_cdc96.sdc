# C27 pin-reduced physical experiment, NOT board/IO/reset/PHY sign-off.
...
# enable/cancel currently have combinational launch cones: AUDIT FINDING,
# these constraints alone do not make those control crossings glitch-free.
