// C27 diagnostic ONLY: equal FIFO RTL, uppercase baseline vs async_reg + syn_keep.
// Original production FIFO is not edited. Both read levels drive a peak cone.
module c1_ti60_cdc_fifo_keep_probe (
    ...
    c27_fifo_keep #(.DEPTH(512)) u_ingress_lower (
