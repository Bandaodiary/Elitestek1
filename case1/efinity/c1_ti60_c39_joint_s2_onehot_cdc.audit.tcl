...
# C39 joint probe uses FRAME_DIVISOR=1: both odd and even raw tags occur.
...
report_timing -setup -from_clock cam_clk -to_clock cam_clk -npaths 10 -nworst 1 -file c27_camera_setup.rpt
report_timing -hold -from_clock cam_clk -to_clock cam_clk -npaths 10 -nworst 1 -file c27_camera_hold.rpt
...
report_timing -setup -from_clock cam_clk -to_clock core_clk -npaths 200 -nworst 1 -file c27_camera_to_core.rpt
report_timing -setup -from_clock core_clk -to_clock cam_clk -npaths 200 -nworst 1 -file c27_core_to_camera.rpt
puts "C27_AUDIT_PASS"
