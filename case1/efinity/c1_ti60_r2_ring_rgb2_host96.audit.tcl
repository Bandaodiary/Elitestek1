...
# This fixed probe uses FRAME_DIVISOR=2: admitted raw frame tags are even.
...
check_pins tag_source {u_host/u_system/u_ingress/source_tag[*]~FF|CLK} 31
check_pins tag_destination {u_host/u_system/capture_tag[*]~FF|D} 31
