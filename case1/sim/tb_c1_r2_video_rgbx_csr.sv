`timescale 1ns/1ps
module tb_c1_r2_video_rgbx_csr;
    ...
    initial begin
        ...
        apb(0,'h00,0,0,0,'h52325632);apb(0,'h04,0,0,0,'h10000);
        ...
        $display("C1_R2_RGBX_CSR_PASS checks=%0d masked_writes=1 reserved_reject=1 irq_set_wins=1 disabled_completion=1 reset=1",checks);$finish;
    end
