...
module tb_c1_r2_resize_pipeline;
...
`endif
    ...
    initial begin
        ...
        $display(
            "C1_R2_RESIZE_PIPELINE_PASS configs=%0d outputs=%0d cfg_errors=%0d aborts=%0d",
