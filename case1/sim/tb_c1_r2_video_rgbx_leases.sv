`timescale 1ns/1ps
module tb_c1_r2_video_rgbx_leases;
    ...
    initial begin
        ...
        $display("C1_R2_RGBX_LEASE_PASS checks=%0d captures=%0d nn=%0d displays=%0d raw_slots=4 output_slots=3 concurrent_front_pending_nn_capture=1 no_swap_wait=1 reset=1",checks,cap_jobs,nn_jobs,display_jobs);$finish;
    end
