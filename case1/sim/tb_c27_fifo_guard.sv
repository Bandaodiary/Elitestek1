...
module tb_c27_fifo_guard;
    ...
    c27_fifo_keep #(.DATA_WIDTH(32),.DEPTH(DEPTH)) dut(.*);
    ...
    initial begin
        ...
        $display("C27_FIFO_KEEP_PASS depth=%0d wh=%0d rh=%0d words=%0d epochs=3 held=%0d full_cycles=%0d capacity=%0d",DEPTH,WH,RH,total,held,fulls,DEPTH+1);
        $finish;
    end
