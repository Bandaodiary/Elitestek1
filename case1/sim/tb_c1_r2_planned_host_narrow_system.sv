`timescale 1ns/1ps
module tb_c1_r2_planned_host_narrow_system;
    ...
    c1_r2_planned_host_system #(.CPU_ID_WIDTH(ID_BITS),.WIDTH(8),.HEIGHT(8)) dut (
        .clk(clk),
        .rst(rst),
        .platform_ready(1'b0),
        .psel(1'b0),
